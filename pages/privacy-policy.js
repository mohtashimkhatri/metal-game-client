...
export default function Privacypolicy() {
    return (
        <div>
            <Head>
                <title>Privacy Policy | Metal Games</title>
                <link rel="icon" href="/favicon.ico" />
            </Head>
            <div className=''>
                <Header />
            </div>
            <div className='mt-8 px-7 pb-8' style={{ marginTop: "10rem" }}>
                <h1 className='mt-10' style={{ marginBottom: "1rem", fontSize: '1.6rem' }}>Privacy Policy</h1>
                ...
                <h2 style={{ marginTop: "1rem", marginBottom: "1rem", fontSize: '1.3rem' }}>
                ...
                <ul>
                    ...
                    <li>Application means the software program provided by the Company downloaded by You on any electronic device, named Metal Games apps</li>
                    <li>
                        Company (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to metal-games.com, North Karachi, Karachi, Sindh, Pakistan.
                    </li>
                    <li>Country refers to: Pakistan
                    </li>
                    ...
                    <li>Service refers to the Application.
                    </li>
                ...
                <p>Email Address: <a href='mailto:hello@metal-games.com' className='text-orange-500'>hello@metal-games.com</a></p>
            </div>
        </div>
    )
}
